...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="../controllers/editarProducto.php?id=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="precio" name="precio" class="money" value="<?php echo $producto->precio; ?>"/>					
				</div>
			</div>
			<div class="control-group">
						...
						<select name="categoria">
							<?php			
								foreach ($lista as $obj) {
									if($obj['id'] == $producto->categoria) {?>
										<option selected id="<?php echo $obj['id'];?>" value="<?php echo $obj['id'];?>"><?php echo $obj['nombre'];?></option>
							<?php 
									}else {?>
			...
			<div style="display:table-cell;">
				...
				   <input id="photo" class="input-large" type="text" value="<?php echo $producto->foto;?>"> 
				   <a class="btn" onclick="$('input[id=file]').click();">Subir</a> 
				</div>
				<br/><br/>
				<img style="padding-left: 54px;" id="blah" src="<?php echo $producto->foto;?>" alt="your image" />
			</div>			
			<div class="control-group">
				<br/>
				<label class="control-label" for="descripcion">Descripci&oacute;n</label>
				<div class="controls">
					<textarea id="descripcion" name="descripcion" rows="6" cols="120" class="span6"> <?php echo $producto->descripcion;?></textarea>
				</div>
			</div>
			<div class="control-group">
					<div class="controls">
