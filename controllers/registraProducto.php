<?php
	...
	if(isset($_SESSION['user_type'])&&$_SESSION['user_type']==0){
		...
		if(isset($_POST["nombre"]) && isset($_POST["categoria"]) && isset($_POST["descripcion"]) && isset($_POST["precio"]) && (!empty($_FILES))){
			...
			include_once("../views/registraProducto.php");
		}
	}else{
